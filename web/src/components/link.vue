<template>
  <div class="link" :class="{'edit': editMode}">
    ...
    <div v-if="editMode" class="action delete" title="Delete link" @click="deleteLink">
    ...
    <div v-if="editMode" class="action edit" title="Edit link" @click="editLink">
...
import {getContrast} from "@/helpers.js"
